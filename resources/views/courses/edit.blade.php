                ...
                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-100 p-6 space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="md:col-span-2">
                            ...
                            <x-text-input id="name" name="name" type="text" value="{{ old('name', $course->name) }}" class="mt-1 block w-full" required />
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="code" value="Course Code" />
                            <x-text-input id="code" name="code" type="text" value="{{ old('code', $course->code) }}" class="mt-1 block w-full" placeholder="e.g., CC, FC, IP" />
                        ...
                        <div>
                            ...
                            <x-text-input id="duration_months" name="duration_months" type="number" min="1" value="{{ old('duration_months', $course->duration_months) }}" class="mt-1 block w-full" placeholder="e.g., 6, 12" />
                        ...
                        <div class="md:col-span-2">
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="is_active" value="1" @checked(old('is_active', $course->is_active)) class="rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
