<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Add Branch</h2>
                <p class="mt-1 text-sm text-gray-500">Add a new branch/location for the institution.</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="bg-white shadow-sm sm:rounded-lg border border-gray-100 p-6 space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="code" name="code" type="text" value="{{ old('code') }}" class="mt-1 block w-full" placeholder="e.g., CC, MC, SZ" />
                        ...
                        <div>
                            ...
                            <x-text-input id="contact_number" name="contact_number" type="text" value="{{ old('contact_number') }}" class="mt-1 block w-full" placeholder="e.g., +91XXXXXXXXXX" />
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="address" name="address" rows="3" class="mt-1 block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" placeholder="Branch address (optional)">{{ old('address') }}</textarea>
